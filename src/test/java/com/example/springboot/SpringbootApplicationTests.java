...
import com.example.utils.WordTemplate;
...
class SpringbootApplicationTests {
    ...
    public void contextLoads() throws IOException {
        ...
        File file = new File("/Users/tengyupei/Downloads/w1.docx");//改成你本地文件所在目录
        ...
        //生成文件
        File outputFile=new File("/Users/tengyupei/Downloads/w2.docx");//改成你本地文件所在目录
